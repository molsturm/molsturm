...
# TODO Convert into folder of yaml files
...
cases = {
  "He_aug-cc-pvdz":
  {
    ...
    "reference_mp2": {
      "energy_mp2": -0.026962512,
      "energy_ground_state": -2.882667179,
    }
  },
# ----------------------------------------------------------------------
  "H2O_sto-3g":
  {
    "system":   system_h2o,
    "params": {
      "atoms":        system_h2o["atoms"],
      "coords":       system_h2o["coords"],
      #
      "guess_method": "hcore",
      "basis_type":   "gaussian/libint",
      "basis_set":    "sto-3g",
    ...
    "reference_mp2": {
      "energy_mp2": -0.034258802,
      "energy_ground_state": -74.993578089,
    }
  },
# ----------------------------------------------------------------------
  "ethane_3-21g":
  {
    "params": {
      "atoms":         system_ethane["atoms"],
      "coords":        system_ethane["coords"],
      #
      "guess_method": "hcore",
      "basis_type":   "gaussian/libint",
      "basis_set":    "3-21g",
    ...
    "reference_mp2": {
      "energy_mp2": -0.191344399,
      "energy_ground_state": -78.984876913,
    }
  },
# ----------------------------------------------------------------------
  "H2O_3-21g":
  {
    "description": "H2O_3-21g",
    "params": {
      "atoms":        system_h2o["atoms"],
      "coords":       system_h2o["coords"],
      #
    ...
    "reference_hf": {  # ORCA
      "energy_total":  -75.585413896429,
      "energy_1e":     -122.76990636,
      "energy_2e":     37.93301319,
      "energy_nucrep": 9.25147927,
      "energy_mos":
                  2* [ -20.422097,  -1.326982,  -0.697499,
                       -0.528446,   -0.476916,   0.266528,
                        0.366603,    1.226759,   1.285413,
                        1.785185,    1.855704,   2.027887,
                        3.109652, ],
    },
    "reference_mp2": {
      "energy_mp2": -0.121577659,
      "energy_ground_state": -75.706991556,
    }
  },
# ----------------------------------------------------------------------
  "Be_ccpvdz":
  {
    ...
    "reference_hf": {  # ORCA
      "energy_total":  -14.572337630930,
      "energy_1e":     -19.06194585,
      "energy_2e":      4.48960822,
      "energy_nucrep":  0,
      "energy_mos":
                     2* [ -4.732326, -0.309039,  0.058259,
                           0.058259,  0.058259,  0.298823,
                           0.350180,  0.350180,  0.350180,
                           0.644274,  0.644274,  0.644274,
                           0.644274,  0.644274, ]
    },
    # TODO This test fails ... no clue why
    "reference_mp2": {
      "energy_mp2": -0.026331169,
      "energy_ground_state": -14.598668800,
    }
  },
}
